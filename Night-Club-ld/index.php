            ...
            <div class="container_logo">
                <div class="content_night">
                    ...
                    <div class="button_mid">
                        <button class="button_left_booking right">Забронировать столик</button>
                    ...
                    <div class="reght_content_about">
                        ...
                        <div class="slider-container">
                            ...
                            <div class="slider_arrow">
                                <div class="slider-arrow left" onclick="prevSlide()"><img src="./vector/arrow_slider_left.svg" alt="">
                                </div>
                                <div class="slider-arrow right" onclick="nextSlide()"><img src="./vector/arrow_slider_right.svg" alt="">
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="contact_content">
                    <div class="contact_content_left">
                        ...
                        <h1 class="title_cont">Забронировать столик</h1>
                        <button class="online_cont">Онлайн бронирование</button>
                        <h1></h1>
