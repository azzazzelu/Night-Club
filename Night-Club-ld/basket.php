                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="modal_form" action="" method="post">
                                            ...
                                            <input type="text" id="number_phone" name="number_phone"
                                                placeholder="+7 (999) 999-99-99" required="required"></input>

                                            <input type="text" id="address" name="address" placeholder="Адрес доставки"
                                                required="required"></input>

                                            <input type="text" id="comment" name="comment"
                                                placeholder="Комментарий к заказу" required="required"></input>

                                            <div class="buy_modal">
                                                <div class="payment">Оплата</div>

                                                <div class="cask_or_Onlinebank">
                                                    <input type="radio" name="buy" id="cask_or_Onlinebank"
                                                        required="required"></input>
